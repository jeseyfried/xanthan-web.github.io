...
This folder contains example pages that demonstrate how to use various page components like image galleries, headers, typography styles, and scrolling effects. These pages serve as both documentation and copy-paste references. You can keep this folder while you're learning, or delete it once you're comfortable. All the same documentation is available on the main Xanthan website.

### `guides/`
**Tutorial and how-to pages**

You're reading one of these guides right now! This folder contains instructional pages that teach you how to use Xanthan—understanding folders, editing pages, adding images, and more. Like the components folder, you can delete this once you're comfortable with the system. It's here to help you learn, not required for your site to function.
