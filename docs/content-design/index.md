...
class="right"
width="40%"
text="You're crafting an experience where visual design and written argument work together."
%}
...
{% include typography/alert.html
  text="**Xanthan gives you powerful, reusable components that handle the technical complexity while leaving you in creative control.** 
  - Want a full-width header image? Copy a few lines of code. 
  - Need to emphasize a quotation? Use a pull quote component. 
  - Want to experiment with how images and text interact? Try a ScrollStory that layers text over images as readers scroll."
  class="info"
%}
...
{% include layout/feature-row.html
  title="Typography"
  text="Text formatting shapes reading experiences. Create clear visual hierarchies with headings, emphasize key passages with pull quotes and blockquotes, and use footnotes that don't disrupt the reading flow. Good typography isn't about making text look pretty—it's about making ideas clear."
  link="typography"
  button="Typography"
  text-width="75"
%}
...
{% include layout/feature-row.html
  title="Images"
  text="Integrate visual evidence into your writing. Position images alongside text, create full-width \"jumbotron\" moments, compare images side-by-side, and build image carousels. Where do readers need visual evidence? When should an image dominate the screen? How can images work with text rather than just illustrate it?"
  link="images"
  button="Images"
  text-width="75"
%}
...
{% include layout/feature-row.html
  title="Colors, Fonts, Themes"
  text="Define the visual identity of your entire site. Choose a color palette that sets your site's tone, select typefaces that match your content's character, and create consistent visual unity across all your pages. Want a serious, academic feel? Playful and experimental? Minimalist and modern?"
  link="colors-fonts-themes"
  button="Colors & Fonts"
  text-width="75"
%}
...
{% include layout/feature-row.html
  ...
  text="Help visitors navigate your content with top navigation bars, card-based layouts for essay collections, and interactive maps. Good navigation isn't just about usability—it's about showing readers how your ideas connect and inviting them to explore."
  link="../navigation/"
  button="Navigation"
  text-width="75"
%}
...
{% include layout/feature-row.html
  title="ScrollStories"
  text="Bring design elements together into immersive narrative experiences. Layer text over background images, create side-scrolling sequences, and build stories that reveal themselves as readers scroll. This is where typography, images, and layout combine into something greater than the sum of their parts."
  link="../scrollstories/"
  button="ScrollStories"
  text-width="75"
%}
...
{: .link-callout}
**[Learn how to work productively with AI →](using-ai-assistance)**

{% include typography/alert.html
  title="Getting Help"
  text="As you experiment, you'll have questions and hit snags. That's normal and expected.

**[Troubleshooting](troubleshooting)** addresses common issues and how to fix them—from pages not updating to images not loading.

**[Using AI Assistance](using-ai-assistance)** shows you how to get help from AI tools when you're stuck or want to try something new."
  class="info"
%} 
